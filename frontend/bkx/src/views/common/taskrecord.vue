...
<script>
    ...
    export default {
        ...
        // },
        mounted () {
            const condition = localStorage.getItem('info')
            if (condition != null) {
                this.temptableData = JSON.parse(condition)
                this.pagination.count = this.temptableData.length
            } else {
                this.temptableData = this.$route.query.row
                this.pagination.count = this.temptableData.length
            }
            localStorage.setItem('info', JSON.stringify(this.temptableData))
        },
