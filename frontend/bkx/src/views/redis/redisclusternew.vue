<template>
    <div style="width: 600px;">
        <bk-form :label-width="200" :model="formData" :rules="rules" ref="formData">
            <bk-form-item label="集群名称" :property="'password'" :error-display-type="'normal'">
                <bk-input v-model="formData.cluster_name" placeholder=""></bk-input>
                <p class="mt5 mb0 f12" slot="tip"></p>
            </bk-form-item>
            <bk-form-item label="云" :required="true" :property="'yun'">
            ...
            <bk-form-item label="地区" :required="true" :property="'zone'">
            ...
            <bk-form-item label="Sentinel IP列表" :required="true" :property="'master_list'" :error-display-type="'normal'">
                <bk-input type="textarea" v-model="formData.master_list" placeholder=""></bk-input>
            </bk-form-item>
            <bk-form-item label="Redis IP列表" :required="true" :property="'master_list'" :error-display-type="'normal'">
                <bk-input type="textarea" v-model="formData.master_list" placeholder=""></bk-input>
            </bk-form-item>
            <bk-form-item label="redis密码" :property="'password'" :error-display-type="'normal'">
                <bk-input v-model="formData.cluster_name" placeholder="请输入redis密码"></bk-input>
                <p class="mt5 mb0 f12" slot="tip"></p>
            </bk-form-item>
