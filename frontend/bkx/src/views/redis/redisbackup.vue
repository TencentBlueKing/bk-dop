<template>
    <div style="width: 600px;">
        <bk-form :label-width="200" :model="formData" :rules="rules" ref="formData">
            <bk-form-item label="备份实例列表" :required="true" :property="'master_list'" :error-display-type="'normal'">
                <bk-input type="textarea" v-model="formData.master_list" placeholder=""></bk-input>
            </bk-form-item>
            <bk-form-item label="备份位置" :required="true" :property="'yun'">
            ...
            <bk-form-item label="备份选项" :required="true" :property="'zone'">
