<template>
    <div style="width: 600px;">
        <bk-form :label-width="200" :model="formData" :rules="rules" ref="formData">
            <bk-form-item label="InstanceList" :required="true" :property="'master_list'" :error-display-type="'normal'">
                <bk-input type="textarea" v-model="formData.master_list" placeholder=""></bk-input>
            </bk-form-item>
            <bk-form-item label="大key返回限制数" :required="true" :property="'zone'">
            ...
            <bk-form-item label="超时控制(可选,单位:秒）" :property="'password'" :error-display-type="'normal'">
