<template>
    <div style="width: 600px;">
        <bk-form :label-width="200" :model="formData" :rules="rules" ref="formData">
            ...
            <bk-form-item label="redis主从" :required="true" :property="'master_list'" :error-display-type="'normal'">
                <bk-input type="textarea" v-model="formData.master_list" placeholder="请输入redis主从ip列表，主从空格分开如: 1.1.1.1 2.2.2.2"></bk-input>
            </bk-form-item>
