...
class KazooPushPkgService(GeneralService):
    ...
    def execute(self, data, parent_data):
        ...
        kwargs = {
            ...
            "file_source_list": [
                {
                    "file_list": ["/data/package/module/kazoo-2.8.0.tar.gz"],
                    "account": {"alias": "root"},
...
class KazooPushPkgComponent(Component):
    name = __name__
    code = 'kazoo_push_pkg_action'
    bound_service = KazooPushPkgService
