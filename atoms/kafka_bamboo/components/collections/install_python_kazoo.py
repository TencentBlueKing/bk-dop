...
class InstallKazooService(GeneralService):
    def execute(self, data, parent_data):
        ...
        kwargs = {
            ...
            "script_content":
                get_script('kafka_bamboo/components/collections/script_templates/install_python_kazoo.sh'),
            "target_server": {
...
class InstallKazooComponent(Component):
    name = __name__
    code = 'install_kazoo_action'
    bound_service = InstallKazooService
