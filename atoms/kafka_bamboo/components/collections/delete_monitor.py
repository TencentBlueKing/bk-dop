...
class DeleteKafkaMonitorService(GeneralService):
    def execute(self, data, parent_data):
        ...
        kwargs = {
            ...
            "script_content": get_script('kafka_bamboo/components/collections/script_templates/delete_monitor.sh'),
...
class DeleteKafkaMonitorComponent(Component):
    name = __name__
    code = 'delete_delete_monitor_action'
    bound_service = DeleteKafkaMonitorService
