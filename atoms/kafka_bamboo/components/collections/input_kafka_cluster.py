...
class CheckBrokerClusterService(GeneralService):
    ...
    def execute(self, data, parent_data):
        ...
        kwargs = {
            ...
            "script_content": get_script('kafka_bamboo/components/collections/script_templates/check_kafka_broker.sh'),
...
class CheckBrokerComponent(Component):
    name = __name__
    code = 'check_broker_action'
    bound_service = CheckBrokerClusterService
