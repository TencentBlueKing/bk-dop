...
class CollectionsCC(object):
    ...
    def __init__(self, client):
        ...
        self.add_app = ComponentAPI(
            client=self.client, method='POST', path='/api/c/compapi{bk_api_ver}/cc/add_app/', description=u'新建业务'
        )
        self.add_module = ComponentAPI(
            client=self.client, method='POST', path='/api/c/compapi{bk_api_ver}/cc/add_module/', description=u'新建模块'
        )
        self.add_plat_id = ComponentAPI(
            client=self.client, method='POST', path='/api/c/compapi{bk_api_ver}/cc/add_plat_id/', description=u'新增子网ID'
        )
        self.add_set = ComponentAPI(
            client=self.client, method='POST', path='/api/c/compapi{bk_api_ver}/cc/add_set/', description=u'新建集群'
        )
        self.del_app = ComponentAPI(
            client=self.client, method='POST', path='/api/c/compapi{bk_api_ver}/cc/del_app/', description=u'删除业务'
        )
        ...
        self.del_module = ComponentAPI(
            client=self.client, method='POST', path='/api/c/compapi{bk_api_ver}/cc/del_module/', description=u'删除模块'
        )
        self.del_plat = ComponentAPI(
            client=self.client, method='POST', path='/api/c/compapi{bk_api_ver}/cc/del_plat/', description=u'删除子网'
        )
        self.del_set = ComponentAPI(
            client=self.client, method='POST', path='/api/c/compapi{bk_api_ver}/cc/del_set/', description=u'删除集群'
        )
        ...
        self.edit_app = ComponentAPI(
            client=self.client, method='POST', path='/api/c/compapi{bk_api_ver}/cc/edit_app/', description=u'编辑业务'
        )
        self.enter_ip = ComponentAPI(
            client=self.client, method='POST', path='/api/c/compapi{bk_api_ver}/cc/enter_ip/', description=u'导入主机到业务'
        )
        ...
        self.get_app_by_id = ComponentAPI(
            client=self.client, method='GET', path='/api/c/compapi{bk_api_ver}/cc/get_app_by_id/', description=u'查询业务信息'
        )
        ...
        self.get_app_list = ComponentAPI(
            client=self.client, method='GET', path='/api/c/compapi{bk_api_ver}/cc/get_app_list/', description=u'查询业务列表'
        )
        ...
        self.get_plat_id = ComponentAPI(
            client=self.client, method='GET', path='/api/c/compapi{bk_api_ver}/cc/get_plat_id/', description=u'查询子网列表'
        )
